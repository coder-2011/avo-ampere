...
- `fix: align mma sequence guard with wrapper` made wrapper-advertised MMA sequence caps match the CUDA guard; follow-up bounded loops advanced the MMA source to accepted seq2048, seq4096, and seq8192 lanes.
...
Score the BF16 WMMA QK/PV attention candidate on the accepted seq8192 lane:
...
- Scaling the accepted seq8192 WMMA QK/PV seed toward the remaining long-sequence target shapes.
